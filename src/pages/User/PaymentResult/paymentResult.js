...
function PaymentResult() {
  ...
  const handlePaymentResult = () => {
    ...
    request.post(`/api/processPaymentResult`, infoPaymentResult).then((res) => {
  ...
  return (
    <div class="container">
      <div className="row">
        <h6>Số tiền thanh toán: {infoPaymentResult.vnp_Amount / 100}</h6>
        ...
        <h6>
          ...
          {infoPaymentResult.vnp_ResponseCode == "00"
            ? "Thành công"
            : "Không thành công"}
        </h6>
